...
---
 ...
 <!--<br>⚡ 
 # 💫 About Me:
 👯 i'm looking to collaborate on projects related to combination of Finance, Management, Data Science and  Generative AI related topics. <br>🌱 I'm currently learning Stock market Analysis and Generative AI. <br>💬 Ask me about Finance, Management, Data Science related topics.Fun Fact : Everything I learnt in past Repeatedly Arrives as Dejavu for me. I can see this quote more often in my Life - ' History Repeats again always  '-->

## 🚀 8 Financial Crime ML Projects (All Live)

| # | Project | Key Metric | Target Role |
|---|---------|-----------|-------------|
| P1 | [AML Transaction Monitoring Dashboard](link) | ROC-AUC 1.00 · 324 alerts · ₹6.15Cr | AML/KYC |
| P2 | [KYB Entity Risk Scoring Engine](link) | CV-AUC 1.00 · 205 high-risk · 0 FN | AML/KYC · BA |
| P3 | [Sanctions & PEP Screening Tool](link) | Recall 100% · F1 98.6% · 0 missed | AML/KYC · Fraud |
| P4 | [Financial Crime / Fraud Detection ML](link) | PR-AUC 1.00 · 0 false negatives | Fraud Risk |
| P5 | [Loan Default Prediction — Credit Scorecard](link) | Gini 0.521 · KS 0.395 · AUC 0.761 | Credit Risk · Quant |
| P6 | [Financial KPI Dashboard — NBFC](link) | 8 KPIs · AUM/NPA/NIM/PAR/PCR · SQL | Data Analyst |
| P7 | [BA Case Study — KYB Onboarding Automation](link) | TAT 5d→1d · ₹6.65L/month saved | BA Finance · Ops |
| P8 | [FinRisk MLOps Pipeline](link) | FastAPI · Docker · MLflow · GCP | MLOps Engineer |
...
**AML/Compliance:** KYC · KYB · UBO · Sanctions · OFAC · World-Check · SAR · PMLA  
**ML/Python:** XGBoost · Gradient Boosting · Random Forest · SMOTE · scikit-learn · rapidfuzz  
**Credit Risk:** Gini · KS Statistic · IV/WoE · PD Modelling · Basel III · FOIR · NPA · PAR  
**MLOps:** FastAPI · Docker · MLflow · Evidently AI · GitHub Actions · GCP Cloud Run · Airflow  
**Data:** Oracle SQL · PL-SQL · BigQuery · Power BI · Pandas · NumPy · Chart.js  
**BA:** BRD · User Stories · Process Mapping · MoSCoW · RACI · As-Is/To-Be  

---

## 🎓 Education & Certifications

- MBA Business Analytics — Manipal University (2024)
- B.Com Finance — Bangalore University (2022)
- CAML Certified (YourAccel) | IBM Data Science Professional | Google Data Analytics

---

## 📬 Open to Opportunities

**Roles:** AML/KYC · Fraud Risk · Credit Risk · Data Analyst · BA Finance · MLOps · Quant · Ops Analyst  
**Locations:** Bengaluru · Hyderabad · Mumbai · Chennai | **Notice:** Immediate
